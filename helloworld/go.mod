...
require (
	git.xq5.com/middleground-open/HorusSDK v1.1.13
...
require (
	git.xq5.com/middleground-open/ConfigCenterSDK v0.0.0-20220727094508-faa11fca355f // indirect
	...
	github.com/luyan-lyyy/gormetrics v0.0.2 // indirect
