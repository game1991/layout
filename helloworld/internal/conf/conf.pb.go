...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb4, 0x02, 0x0a, 0x06,
	0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	...
	0x15, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_HTTP)(nil),         // 1: conf.api.Server.HTTP
	(*Server_GRPC)(nil),         // 2: conf.api.Server.GRPC
	(*durationpb.Duration)(nil), // 3: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1, // 0: conf.api.Server.http:type_name -> conf.api.Server.HTTP
	2, // 1: conf.api.Server.grpc:type_name -> conf.api.Server.GRPC
	3, // 2: conf.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	3, // 3: conf.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
